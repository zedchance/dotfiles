...
hi Normal     guisp=NONE guifg=#aeb5bd guibg=NONE    ctermfg=249 ctermbg=236  gui=NONE      cterm=NONE
...
hi PreProc    guisp=NONE guifg=#e0e0e0 guibg=NONE    ctermfg=231 ctermbg=NONE gui=NONE      cterm=NONE
...
hi Number         guisp=NONE guifg=#488ff9 guibg=NONE    ctermfg=33  ctermbg=NONE gui=NONE   cterm=NONE
hi Boolean        guisp=NONE guifg=#e0e0e0 guibg=NONE    ctermfg=231 ctermbg=NONE gui=NONE   cterm=NONE
hi Float          guisp=NONE guifg=#488ff9 guibg=NONE    ctermfg=33  ctermbg=NONE gui=NONE   cterm=NONE
...
hi StorageClass   guisp=NONE guifg=#e0e0e0 guibg=NONE    ctermfg=231 ctermbg=NONE gui=NONE   cterm=NONE
...
hi SpecialChar    guisp=NONE guifg=#e0e0e0 guibg=NONE    ctermfg=231 ctermbg=NONE gui=NONE   cterm=NONE
hi Tag            guisp=NONE guifg=#e0e0e0 guibg=NONE    ctermfg=231 ctermbg=NONE gui=NONE   cterm=NONE
hi Delimiter      guisp=NONE guifg=#d9af6c guibg=NONE    ctermfg=179 ctermbg=NONE gui=NONE   cterm=NONE
hi SpecialComment guisp=NONE guifg=#e0e0e0 guibg=NONE    ctermfg=231 ctermbg=NONE gui=NONE   cterm=NONE
hi Debug          guisp=NONE guifg=#e0e0e0 guibg=NONE    ctermfg=231 ctermbg=NONE gui=NONE   cterm=NONE
...
hi Cursor           guisp=NONE guifg=#e0e0e0 guibg=#1c1c1c ctermfg=231  ctermbg=234  gui=NONE           cterm=NONE
hi lCursor          guisp=NONE guifg=#e0e0e0 guibg=#1c1c1c ctermfg=231  ctermbg=234  gui=NONE           cterm=NONE
hi CursorIM         guisp=NONE guifg=#e0e0e0 guibg=#1c1c1c ctermfg=231  ctermbg=234  gui=NONE           cterm=NONE
hi CursorColumn     guisp=NONE guifg=#e0e0e0 guibg=#1c1c1c ctermfg=231  ctermbg=234  gui=NONE           cterm=NONE
...
hi DiffAdd          guisp=NONE guifg=#46744c guibg=#46744c ctermfg=NONE ctermbg=240  gui=NONE           cterm=NONE
hi DiffChange       guisp=NONE guifg=#455663 guibg=#455663 ctermfg=NONE ctermbg=240  gui=NONE           cterm=NONE
hi DiffDelete       guisp=NONE guifg=#4c393a guibg=#4c393a ctermfg=NONE ctermbg=238  gui=NONE           cterm=NONE
hi DiffText         guisp=NONE guifg=NONE    guibg=NONE    ctermfg=NONE ctermbg=NONE gui=NONE           cterm=NONE
hi EndOfBuffer      guisp=NONE guifg=#e0e0e0 guibg=NONE    ctermfg=231  ctermbg=NONE gui=NONE           cterm=NONE
hi ErrorMsg         guisp=NONE guifg=#bd693c guibg=NONE    ctermfg=131  ctermbg=NONE gui=NONE           cterm=NONE
hi VertSplit        guisp=NONE guifg=#606366 guibg=#2b2b2b ctermfg=231  ctermbg=234  gui=NONE           cterm=NONE
hi Folded           guisp=NONE guifg=#e0e0e0 guibg=#1c1c1c ctermfg=231  ctermbg=234  gui=NONE           cterm=NONE
hi FoldColumn       guisp=NONE guifg=#e0e0e0 guibg=#1c1c1c ctermfg=231  ctermbg=234  gui=NONE           cterm=NONE
hi SignColumn       guisp=NONE guifg=#e0e0e0 guibg=#2b2b2b ctermfg=231  ctermbg=234  gui=NONE           cterm=NONE
...
hi CursorLineNr     guisp=NONE guifg=#597cc2 guibg=#292929 ctermfg=NONE ctermbg=235  gui=NONE           cterm=NONE
...
hi Pmenu            guisp=NONE guifg=#aeb5bd guibg=#313335 ctermfg=249  ctermbg=238  gui=NONE           cterm=NONE
hi PmenuSel         guisp=NONE guifg=#e0e0e0 guibg=#214283 ctermfg=231  ctermbg=24   gui=NONE           cterm=NONE
...
hi QuickFixLine     guisp=NONE guifg=#e0e0e0 guibg=#1c1c1c ctermfg=231  ctermbg=234  gui=NONE           cterm=NONE
...
hi StatusLineNC     guisp=NONE guifg=NONE    guibg=#313335 ctermfg=NONE ctermbg=235  gui=NONE           cterm=NONE
...
hi TabLine          guisp=NONE guifg=#e0e0e0 guibg=#313335 ctermfg=231  ctermbg=234  gui=NONE           cterm=NONE
hi TabLineFill      guisp=NONE guifg=#e0e0e0 guibg=#313335 ctermfg=231  ctermbg=234  gui=NONE           cterm=NONE
hi TabLineSel       guisp=NONE guifg=#bfa222 guibg=#2b2b2b ctermfg=231  ctermbg=24   gui=NONE           cterm=NONE
hi Terminal         guisp=NONE guifg=#1c1c1c guibg=#1c1c1c ctermfg=231  ctermbg=234  gui=NONE           cterm=NONE
hi Title            guisp=NONE guifg=#aeb5bd guibg=#2b2b2b ctermfg=249  ctermbg=236  gui=NONE           cterm=NONE
hi Visual           guisp=NONE guifg=#e0e0e0 guibg=#214283 ctermfg=231  ctermbg=24   gui=NONE           cterm=NONE
hi VisualNOS        guisp=NONE guifg=#e0e0e0 guibg=#214283 ctermfg=231  ctermbg=24   gui=NONE           cterm=NONE
