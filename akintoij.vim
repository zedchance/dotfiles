...
hi Conceal          guisp=NONE guifg=#aeb5bd guibg=#2b2b2b ctermfg=249  ctermbg=236  gui=NONE           cterm=NONE
...
hi NonText          guisp=NONE guifg=#aeb5bd guibg=#2b2b2b ctermfg=249  ctermbg=236  gui=NONE           cterm=NONE
hi Pmenu            guisp=NONE guifg=#aeb5bd guibg=#2b2b2b ctermfg=249  ctermbg=236  gui=NONE           cterm=NONE
hi PmenuSel         guisp=NONE guifg=#aeb5bd guibg=#2b2b2b ctermfg=249  ctermbg=236  gui=NONE           cterm=NONE
hi PmenuSbar        guisp=NONE guifg=#aeb5bd guibg=#2b2b2b ctermfg=249  ctermbg=236  gui=NONE           cterm=NONE
hi PmenuThumb       guisp=NONE guifg=#aeb5bd guibg=#2b2b2b ctermfg=249  ctermbg=236  gui=NONE           cterm=NONE
...
hi StatusLineNC     guisp=NONE guifg=#a4a3a3 guibg=#313335 ctermfg=248  ctermbg=236  gui=NONE           cterm=NONE
...
hi Comment    guisp=NONE guifg=#7a7a7a guibg=NONE    ctermfg=243 ctermbg=NONE gui=NONE      cterm=NONE
...
hi Include        guisp=NONE guifg=#828eba guibg=NONE    ctermfg=103 ctermbg=NONE gui=bold   cterm=bold
hi Define         guisp=NONE guifg=#828eba guibg=NONE    ctermfg=103 ctermbg=NONE gui=bold   cterm=bold
hi Macro          guisp=NONE guifg=#828eba guibg=NONE    ctermfg=103 ctermbg=NONE gui=bold   cterm=bold
